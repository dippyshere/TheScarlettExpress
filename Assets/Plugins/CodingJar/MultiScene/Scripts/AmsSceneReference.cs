...
public struct AmsSceneReference
{
    ...
    public override bool Equals(object obj)
    {
        ...
        AmsSceneReference otherScene = (AmsSceneReference)obj;
    ...
    public Scene scene
    {
        get
        {
            ...
            {
                // The easy case
                Scene scene = SceneManager.GetSceneByPath(editorPath);
                if (scene.IsValid())
                {
                ...
                if (BuildPipeline.isBuildingPlayer)
                {
                    ...
                    AmsMultiSceneSetup[] allMultiSceneSetups = Resources.FindObjectsOfTypeAll<AmsMultiSceneSetup>();
                    foreach (AmsMultiSceneSetup sceneSetup in allMultiSceneSetups)
                    {
            ...
            Scene editorScene = SceneManager.GetSceneByPath(editorPath);
