...
namespace CodingJar.MultiScene
{
	...
	/// </summary>
	public static class AmsPreferences
    {
        ...
        public static CrossSceneReferenceHandling CrossSceneReferencing
        {
            get
            {
                return (CrossSceneReferenceHandling)EditorPrefs.GetInt("AmsCrossSceneReferencing",
        ...
        {
            return new SettingsProvider("Preferences/Advanced Multi-Scene", SettingsScope.User,
                new[] { "AMS", "Multi-Scene", "References", "Cross-Scene" })
            {
                guiHandler = searchContext => { AmsPreferencesOnGUI(); }
            };
        }
        ...
        {
            CrossSceneReferenceHandling newCrossSceneRefs =
                (CrossSceneReferenceHandling)EditorGUILayout.EnumPopup("Cross-Scene Referencing",
