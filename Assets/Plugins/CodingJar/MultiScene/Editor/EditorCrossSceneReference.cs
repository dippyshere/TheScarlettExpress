...
namespace CodingJar.MultiScene.Editor
{
	...
	public struct EditorCrossSceneReference
    {
        ...
        public override string ToString()
        {
            ...
            GameObject fromGameObject = fromObject.EditorGetGameObjectFromComponent();
            if (fromGameObject)
            {
                fromString = string.Format("{0} ({1})", fromGameObject.GetFullName(), fromObject.GetType());
            }

            GameObject toGameObject = toInstance.EditorGetGameObjectFromComponent();
            if (toGameObject)
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                EditorCrossSceneReference other = (EditorCrossSceneReference)obj;
        ...
        string ToRuntimeSerializableField(SerializedProperty property)
        {
            ...
            string[] splitPaths = parseablePropertyPath.Split('.');
            ...
            for (int i = 0; i < splitPaths.Length; ++i)
            {
                ...
                else
                {
                    ...
                    string indexString = pathPiece.Substring(arrayIndicatorLength,
                    ...
                    {
                        AmsDebug.LogError(null, "Could not parse array index for property path {0}",
