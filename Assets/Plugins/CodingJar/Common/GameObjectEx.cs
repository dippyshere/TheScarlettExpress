...
namespace CodingJar
{
	...
	public static class GameObjectEx
    {
	    ...
	    /// </summary>
	    static readonly List<GameObject> s_GameObjects = new();
	    ...
	    static GameObjectEx()
	    {
		    ...
		    s_GetRootGameObjectsInternal =
			    typeof(Scene).GetTypeInfo().DeclaredMethods.FirstOrDefault(x => x.Name == "GetRootGameObjectsInternal");
#else
		    s_GetRootGameObjectsInternal =
        ...
        /// <summary>
        ///     Unity by default will not return root objects during the initialzation phase of a Scene (i.e. before Awake has
        ///     completed).
        ...
        public static IEnumerable<T> EditorGetScriptableObjects<T>(this GameObject gameObj) where T : ScriptableObject
        {
            ...
            SerializedObject so = new(gameObj);
        ...
        public static GameObject EditorGetGameObjectFromComponent(this Object obj)
        {
            ...
            int gameObjID = InternalEditorUtility.GetGameObjectInstanceIDFromComponent(obj.GetInstanceID());
