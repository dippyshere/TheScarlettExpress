...
namespace Dypsloom.DypThePenguin.Scripts.Damage
{
    ...
    public class Projectile : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            IDamageable damageable = otherRigidBody?.GetComponent<IDamageable>() ?? other.GetComponent<IDamageable>();
            if (damageable != null && damageable == m_ItemUser?.Character.CharacterDamageable)
            {
                return;
            }
