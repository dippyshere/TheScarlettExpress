...
Shader "Custom/Shader_Fluffy_Platform"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutputStandard o)
        {
            ...
            float4 weightedBlend91 = (weightedBlendVar91.x * ((1.0 - fresnelNode81) * lerpResult119) +
                weightedBlendVar91.y * ((temp_output_76_0 * lerpResult119) + ((1.0 - temp_output_76_0) * _NoiseColor)));
