    ...
    public partial class CFXR_Effect : MonoBehaviour
    {
        ...
        public class AnimatedLight
        {
            ...
            public class AnimatedLightDrawer : PropertyDrawer
            {
                ...
                static readonly GUIContent[] ModePopupLabels = { new("Curve"), new("Perlin Noise") };
                static readonly GUIContent IntensityModeLabel = new("Intensity Mode");
                static readonly GUIContent RangeModeLabel = new("Range Mode");
                static readonly GUIContent ColorModeLabel = new("Color Mode");
        ...
        [NonSerialized] ParticleSystem _parentParticle;
        ...
        [NonSerialized] bool particleWasStopped;
        [NonSerialized] float particleTime;
        [NonSerialized] float particleTimeUnwrapped;
