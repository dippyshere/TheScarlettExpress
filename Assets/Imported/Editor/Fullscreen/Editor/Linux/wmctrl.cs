    ...
    public static class wmctrl
    {
        ...
        static wmctrl()
        {
            try
            {
                ...
                int exitCode = Cmd.Run("which wmctrl", false, out stdout, out stderr);
        ...
        static string Run(string format, params object[] args)
        {
            ...
            string result = Cmd.Run("wmctrl " + format, args);
