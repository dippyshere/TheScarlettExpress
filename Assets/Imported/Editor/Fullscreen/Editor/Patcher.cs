...
namespace FullscreenEditor
{
    ...
    public unsafe class Patcher
    {
        ...
        public void Revert()
        {
            ...
            byte* cursor = (byte*)pBody.ToPointer();
        ...
        public void SwapMethods()
        {
            ...
            byte* ptr = (byte*)pBody.ToPointer();
            byte* ptr2 = (byte*)pBorrowed.ToPointer();
            long ptrDiff = ptr2 - ptr - 5;
            bool relativeJumpAvailable = ptrDiff < 0xFFFFFFFF && ptrDiff > -0xFFFFFFFF;
            bool doNotUseRelativeJump = true; // See issues #69 and #89
