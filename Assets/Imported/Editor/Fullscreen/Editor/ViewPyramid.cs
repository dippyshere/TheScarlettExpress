...
namespace FullscreenEditor
{
    ...
    public struct ViewPyramid
    {
        ...
        [SerializeField] ContainerWindow m_container;

        [SerializeField] int m_windowInstanceID;
        [SerializeField] int m_viewInstanceID;
        [SerializeField] int m_containerInstanceID;
