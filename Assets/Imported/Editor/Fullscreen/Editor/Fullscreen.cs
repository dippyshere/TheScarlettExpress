...
namespace FullscreenEditor
{
    ...
    {
        static FullscreenContainer[] cachedFullscreen;
        static FullscreenContainer[] cachedFullscreenAll;
        ...
        public static FullscreenContainer GetFullscreenFromView(ScriptableObject viewOrWindow, bool rootView = true)
        {
            ...
            ViewPyramid pyramid = new(viewOrWindow);
        ...
        {
            Rect rect = FullscreenRects.GetFullscreenRect(FullscreenPreferences.RectSource, window);
            FullscreenWindow fullscreen = ScriptableObject.CreateInstance<FullscreenWindow>();
        ...
        public static FullscreenView MakeFullscreen(ScriptableObject view)
        {
            ...
            Rect rect = FullscreenRects.GetFullscreenRect(FullscreenPreferences.RectSource, view);
            FullscreenView fullscreen = ScriptableObject.CreateInstance<FullscreenView>();
        ...
        {
            Rect rect = FullscreenRects.GetFullscreenRect(FullscreenPreferences.RectSource, window);
            FullscreenContainer oldFullscreen = GetFullscreenFromView(window);
            ...
            FullscreenWindow newFullscreen = MakeFullscreen(type, window);
        ...
        {
            Rect rect = FullscreenRects.GetFullscreenRect(FullscreenPreferences.RectSource, view);
            FullscreenContainer oldFullscreen = GetFullscreenFromView(view);
            ...
            FullscreenView newFullscreen = MakeFullscreen(view);
