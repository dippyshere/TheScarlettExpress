    ...
    public class Demo : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.F))
            {
                ...
                {
                    BeautifySettings.settings.blurIntensity.overrideState =
                        false; // disables the override, disabling the blur
                }
                else
                {
                    BeautifySettings.settings.blurIntensity
                        .Override(4); // enables the override, activating the effect and enabling the blur
                }
            }
