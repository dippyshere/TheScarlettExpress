...
namespace Beautify.Universal
{
    ...
    public class BeautifySettings : MonoBehaviour
    {
        ...
        [Header("Scene Settings")] public Transform sun;
        ...
        public static void SetStripShaderKeywords(Beautify beautify)
        {
            ...
            bool usesColorTweaks = beautify.sepia.value > 0 || beautify.daltonize.value > 0 ||
                                   beautify.colorTempBlend.value > 0;
            ...
            if (beautify.stripBeautifyTonemapping.value ||
            ...
            if (beautify.stripBeautifyChromaticAberration.value ||
                (auto && beautify.chromaticAberrationIntensity.value <= 0))
            {
                sb.Append(BeautifyRendererFeature.SKW_CHROMATIC_ABERRATION);
            }
